    ...
    return (
        <div className='signupWrapper'>
            <div className="signupPageWrapper">
                <div className="signupPageCount" style={val === 1 ? { background: "green" } : {}}>01</div>
                <div className="signupPageCount" style={val === 2 ? { background: "green" } : {}}>02</div>
                <div className="signupPageCount" style={val === 3 ? { background: "green" } : {}}>03</div>
                <div className="signupPageCount" style={val === 4 ? { background: "green" } : {}}>04</div>
            </div>
