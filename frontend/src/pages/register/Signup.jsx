    ...
    function renderSwitch(param) {
        switch (param) {
            case 1:
                return (
                    <>
                        <h2 style={{ width: "100%", textAlign: "center" }}>Verify your Email</h2>
                        <EmailVerify otpMatched={otpMatched} setOtpMatched={setOtpMatched} err={err} setErr={setErr} errMessage={errMessage} setErrMessage={setErrMessage} setUserCredentials={setUserCredentials} setVal={setVal} />
                    </>
                )
            case 2:
                return (
                    <UserDetails err={err} setErr={setErr} errMessage={errMessage} setErrMessage={setErrMessage} setUserCredentials={setUserCredentials} setVal={setVal} setUserDataFlag={setUserDataFlag} />
                )
            case 3:
                return (
                    <ConfirmPassword err={err} setErr={setErr} errMessage={errMessage} setErrMessage={setErrMessage} setUserCredentials={setUserCredentials} setVal={setVal} setPswFlag={setPswFlag} />
                )
            case 4:
                return (
                    <AvatarSelect gender={userCredentials.gender} userCredentials={userCredentials} setUserCredentials={setUserCredentials} setVal={setVal} />
                )
            default:
    ...
    return (
        <div className='signupWrapper'>
            ...
            <div className="signupPageWrapper">
                <div className="signupPageCount" style={val === 1 ? { background: "#3CCF4E" } : {}}>01</div>
                <div className="signupPageCount" style={val === 2 ? { background: "#3CCF4E" } : {}}>02</div>
                <div className="signupPageCount" style={val === 3 ? { background: "#3CCF4E" } : {}}>03</div>
                <div className="signupPageCount" style={val === 4 ? { background: "#3CCF4E" } : {}}>04</div>
            </div>
...
function EmailVerify(props) {
    ...
    function matchOTP() {
        ...
        if (otp.current.value === Otp.otp && email.current.value === Otp.email) {
            ...
            props.setErr("Wrong OTP!!!")
            props.setErrMessage("OTP does not match. Please try again !")
          }
        // console.log('Bye, i am otp');
    }

console.log(props.otpMatched)
        ...
        <div className="emailWrapper">
            ...
            <div className="email_div">
                <input
                    ...
                    placeholder="Email"
                    name="email"
                    className='registerEmailInputField'
                    required={true}
                ...
                {otpSent ? (
                    <div className="otp_div">
                        <input type="text" className='otpRegisterEmailInputField' style={{width: "60%"}} ref={otp} placeholder="Enter OTP" required />
                        <button onClick={matchOTP} className="submit-otp-register-verify-button" >Submit</button>
                    </div>
                ) : (
                    ""
                )}
                <div className="controlBtnWrapper">
                    ...
                    <IconButton aria-label="delete" size="small" className='nextButton' onClick={nextVal}>
                        Next
                        <ArrowForwardIcon fontSize="inherit" />
                    </IconButton>
                </div>
            </div>
            {props.err ? <Popup flag={true} message={props.errMessage} errCallback={errCallback} /> : ""}
            {preloader ? <Preloader /> : ""}
        </div>
    )
}
                ...
                <div className="userDetailsDiv">
                    ...
                    >
                        ...
                        <label htmlFor="gender">
                            ...
                            className='registerEmailInputField' id="gender">
                        ...
                        <div className="controlBtnWrapper">
                            ...
                            <IconButton aria-label="delete" size="small" type="submit" style={{ margin: "2rem 0px" }}>
                                Next
                                <ArrowForwardIcon fontSize="inherit" />
                            </IconButton>
                        </div>
...
function ConfirmPassword(props) {
    ...
    const handleCheckPassword = (e) => {
        e.preventDefault()
        if (password.current.value !== "" && password.current.value === rePassword.current.value) {
            props.setUserCredentials(prev => ({
                ...prev,
