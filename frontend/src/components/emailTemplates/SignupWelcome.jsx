...
export default function SignupWelcome() {
  return (
    ...
    //                                           <tbody>
    //                                             <tr>
    //                                               <td class="esd-block-button es-p10t es-m-txt-c" align="right"><span class="es-button-border"><a href="https://viewstripo.email/" class="es-button" target="_blank">Visit</a></span></td>
    //                                             </tr>
    //                                           </tbody>
    //                                         </table>
    //                                       </td>
