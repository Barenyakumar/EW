...
// export default function PreviewChallengeDetails() {
...
//     const challengeLink = "https://github.com/Barenyakumar/EW"
//     console.log(challengeLink)
//     window.location.replace(challengeLink)
//   }
...
//         </DialogContent>
//         <DialogActions>
//           <CopyToClipboard text={challengeLink} onCopy={() => setCopied(true)}>
//             <Button>Copy </Button>
//           </CopyToClipboard>
